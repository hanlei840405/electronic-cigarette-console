...
//resize on sidebar collapse/expand
    ...
    function receiveAfterSale() {
        var values = {asodID: '${asAftersaleod.asodID}'};
        $.post("${context_path}/mall/aftersale/saveReceive", values, function (data) {
            if (data.code == 0) {
                layer.msg('操作成功', {
                    icon: 1,
