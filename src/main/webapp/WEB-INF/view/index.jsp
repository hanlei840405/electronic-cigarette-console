        ...
        <div id="sidebar" class="sidebar sidebar-fixed responsive">
            ...
            <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                    <button class="btn btn-success" onclick="customNavigation('/mall/customerGift',9997,'商户管理')">
                        商(99)
                    </button>

                    <button class="btn btn-info customNavigation" onclick="customNavigation('/mall/customerGift',9998,'订单审核')">
                        订(99)
                    </button>

                    <!-- #section:basics/sidebar.layout.shortcuts -->
                    <button class="btn btn-warning customNavigation" onclick="customNavigation('/mall/customerGift',9999,'返修单管理')">
                        返(99)
                    </button>
...
<script type="text/javascript">
    ...
    function customNavigation(url,index,title) {
        $("iframe").css("display", "none");
        window.location.hash = url;
        if (url == "/index" || url == "/") {
            url = "/home";
        ...
        if (tab.length > 0) {
            ...
            $(".page-tabs-content").append('<a href="javascript:;" class="J_menuTab active" data-id="' + url + '">' + title + '<i class="fa fa-times-circle"></i></a>');
            tabsEventClear();
            tabsEventInit();
        }
    }
